...
public class CallCentreTests {
    ...
    //авторизация в КЦ
      webDriver.get("http://call.emias.mosreg.ru/call2_dev/to_work/");
      ...
      // Запись на прием
        ...
        Thread.sleep(3000);
        webDriver.findElement(By.xpath ("//div[@id='spec-doc-list']/div[3]/button")).click();
        Thread.sleep(2000);
       ...
       // Запись в лист ожидания
        webDriver.findElement(By.xpath ("//button[@title='СТЕНД ЕМИАС МО; Адрес: Московская область, г. Неизвестный, ул. Светлая, д. 5']")).click();
        Thread.sleep(2000);
        webDriver.findElement(By.xpath ("//div[@id='spec-doc-list']/div[4]/button")).click();
        Thread.sleep(2000);
        webDriver.findElement(By.xpath ("//*[contains(text(),'Записать в лист ожидания')]")).click();
        Thread.sleep(2000);
        webDriver.findElement(By.xpath ("//*[@id='complain']")).sendKeys("тест ожидания");
        webDriver.findElement(By.xpath ("//*[contains(text(),'Оформить')]")).click();
       ...
       //Все записи пациента
        ...
        Thread.sleep(2000);
        webDriver.findElement(By.xpath ("//*[@id='week-doc-schedule-table-body']/tr[2]/td[7]/button")).click();
        Thread.sleep(2000);
