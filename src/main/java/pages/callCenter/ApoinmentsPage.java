...
public class ApoinmentsPage extends AbstractPage {
    ...
    public void apoinmets() throws InterruptedException {
        ...
        apo.click();
        Thread.sleep(2000);
        $(By.xpath("//*[@id='direction-list']/div/div[2]/button")).click();
        Thread.sleep(2000);
        $(By.xpath("//*[@id='a7f391d4-d5d8-44d5-a770-f7b527bb123326f407bc-01c7-4e64-ae16-80ae909b1574']/td[6]/button")).click();
        Thread.sleep(2000);
