...
Функция: 14_Просмотр ошибок
  ...
  Структура сценария: Просмотр ошибки при создании вызова к врачу
    ...
    Когда Тестовый оператор хочет записать пациента повторно к "Селевич Николай Николаевич"
    Тогда он увидит ошибку содержащую "<текст>"
    И Тестовый оператор удаляет запись на прием

    Примеры:
      |          текст              |
      | Вы уже записаны к Селевич Николай Николаевич |
